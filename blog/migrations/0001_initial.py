    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=40, primary_key=True, serialize=False, unique=True, validators=[blog.models.User.validate_username_custom], verbose_name='نام کاربری')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supercategory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.category', verbose_name='سر دسته')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accept_by_admin', models.BooleanField(default=False, verbose_name='برچسب تایید شده است')),
            ],
            options={
                'verbose_name': 'برچسب',
